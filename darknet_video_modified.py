...
#
#if os.name == 'nt':
#    os.add_dll_directory(os.getcwd())  # add darknet folder to dll search path
#    os.add_dll_directory(os.getenv('CUDA_PATH') + '\\bin')  # add cuda bin folder to dll search path
import darknet
import argparse
